...
$url        = 'https://www.udse.de/download/RebootBlockerSetup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'RebootBlocker*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  #silentArgs   = '/VERYSILENT'             # none; make silent with input macro script like AutoHotKey (AHK)
